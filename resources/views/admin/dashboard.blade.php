      ...
      <div class="card border shadow-xs mb-4">
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="row">
            <div class="col-12">
              <div class="w-100">
                <p class="text-sm text-secondary mb-1">Total Views</p>
                <h4 class="mb-2 font-weight-bold">{{\App\Models\Postview::count();}}</h4>
      ...
      <div class="card border shadow-xs mb-4">
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="row">
            <div class="col-12">
              <div class="w-100">
                <p class="text-sm text-secondary mb-1">Views Today</p>
                <h4 class="mb-2 font-weight-bold">{{\App\Models\Postview::whereDate('created_at', date('Y-m-d'))->count();}}</h4>
                {{-- <div class="d-flex align-items-center">
                  <span class="text-sm text-success font-weight-bolder">
